...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        model = [create_custom_mlp(struct)]
        desc = [getMlpStructAsString(struct)]
        test_models('mlp_dropout_20_30_64', model, desc, train_data, train_labels, val_data, val_labels, epochs_p=epochs,
                    batch_size_p=8192)
    ...
    for i in range(10):
        ...
        model = [create_custom_mlp(struct)]
        desc = [getMlpStructAsString(struct)]
        test_models('mlp_dropout_20_30_128', model, desc, train_data, train_labels, val_data, val_labels, epochs_p=epochs,
                    batch_size_p=8192)
    ...
    for i in range(10):
        ...
        model = [create_custom_mlp(struct)]
        desc = [getMlpStructAsString(struct)]
        test_models('mlp_dropout_20_30_256', model, desc, train_data, train_labels, val_data, val_labels, epochs_p=epochs,
                    batch_size_p=8192)
    del model
    del desc
    ...
    for i in range(10):
        ...
        model = [create_custom_mlp(struct)]
        desc = [getMlpStructAsString(struct)]
        test_models('mlp_dropout_20_30_512', model, desc, train_data, train_labels, val_data, val_labels, epochs_p=epochs,
                    batch_size_p=8192)
    del model
    del desc
    ########################################################################
